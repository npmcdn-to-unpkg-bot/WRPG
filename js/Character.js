function Character(id, name, race, level, maxHealth, maxEnergy, maxMana, strength, agility, intelligence, charisma, xpos, ypos) {
...
Character.prototype.getXPos = function() {
  return this.xpos;
}

Character.prototype.getYPos = function() {
  return this.ypos;
}
...
Character.prototype.setXPos = function(val) {
  this.xpos = val;
}

Character.prototype.setYPos = function(val) {
  this.ypos = val;
}
